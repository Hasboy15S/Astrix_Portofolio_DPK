...
<body>    
    ...
    <div >
        ...
        <img src="foto darat/avanza.jpeg" alt="" class="foto-kendaraan">
        <div class="deskripsi-mobil">
        <h1>Mobil Avanza th2021</h1 id="kendaraan">
        <p>Mobil ini berkapasitas 4 orang dengan bagasi yang luas di belakang. 
            kondisi mobil ini normal tidak ada kendala, namun terdapat beberapa bagian cat mobil yang tergores dan busa tempat duduk sudah tidak terlalu empuk.</p>
            <img src="WhatsApp_Image_2024-12-02_at_16.38.06_3267965b-removebg-preview.png" alt="">
            <h1>Rp1.900.000/day</h1>
            <a href="order.php">
                <div class="order">
                    <h1>ORDER NOW!</h1>
                </div>
